...
const SECTIONS = [
  {
    ...
    items: [
      {
        name: "The Supported Accommodation (England) Regulations 2023",
        desc: "All regulatory requirements for supported accommodation providers including admissions and discharges (Reg 28), behaviour management (Reg 22), quality of support reviews (Reg 32), staffing (Regs 11–18), safeguarding (Reg 20), and Ofsted notifications",
      },
      {
