...
const SCORING_RULES = [
  { category: "Reg 27 — Ofsted Notifications", max: 25, rules: "No pending notifications, no overdue notifications, annual notifications recorded" },
  { category: "Reg 32 — Quality of Support Reviews", max: 25, rules: "Annual reviews completed, young people's views captured, action plans with clear ownership" },
  { category: "Annex A — Inspection Readiness", max: 20, rules: "Accommodation category recorded, placing LA recorded, UASC status documented, education/health data complete" },
  { category: "Reg44/45 Governance", max: 10, rules: "Monthly visit, actions reviewed, no overdue, Reg45 done" },
  { category: "Missing/Safeguarding/Incidents", max: 10, rules: "No active MFH, return interviews done, incidents reviewed, no overdue safeguarding" },
  { category: "Training/DBS/Supervision", max: 10, rules: "95%+ training, 100% DBS/RTW, supervision current, induction complete" },
  { category: "Plans & Outcomes", max: 10, rules: "Placement, support, pathway (16+), ILS/move-on, outcomes evidence" },
  { category: "Home Environment & Complaints", max: 5, rules: "Home checks, safety checks, no overdue complaints, outcomes recorded" },
  { category: "Health/Education/Wellbeing", max: 5, rules: "Appointments tracked, education progress, leisure activities, health records" },
];
