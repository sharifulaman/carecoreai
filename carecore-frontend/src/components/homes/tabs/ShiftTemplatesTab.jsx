...
const SHIFT_DEFAULTS = {
  morning: { time_start: "07:00", time_end: "15:00" },
  afternoon: { time_start: "15:00", time_end: "22:00" },
  evening: { time_start: "22:00", time_end: "07:00" },
  night:   { time_start: "22:00", time_end: "07:00" },
};

const SHIFT_ORDER = { morning: 1, afternoon: 2, evening: 3, night: 4 };

const EMPTY_FORM = { name: "", shift_type: "morning", time_start: "07:00", time_end: "15:00", staff_required: 1, notes: "" };
