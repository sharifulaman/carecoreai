...
import PlacementEndNoticeSection from "./PlacementEndNoticeSection";
...
export default function MoveOnDetail({ resident, home, ilsScore, onBack }) {
  ...
  return (
    <div className="space-y-6 bg-card border border-border rounded-lg p-6">
      ...
      {/* Placement End / Immediate Notice */}
      <div className="pt-4 border-t border-border">
        <h3 className="font-semibold mb-4">Placement End / Immediate Notice</h3>
        <PlacementEndNoticeSection resident={resident} home={home} />
      </div>
