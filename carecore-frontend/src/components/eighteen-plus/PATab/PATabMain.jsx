...
const SUBTABS = [
  { key: "details", label: "PA Details" },
  { key: "visits", label: "PA Visits" },
  { key: "reviews", label: "LA Reviews" },
];

import PADetailsSubTab from "./PADetailsSubTab";
...
export default function PATabMain({ residents, homes, staff }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Sub-tab content */}
      {activeSubTab === "details" && <PADetailsSubTab residents={residents} homes={homes} staff={staff} />}
