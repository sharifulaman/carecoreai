    ...
    <div className="mt-4 space-y-4">
      ...
      <Section title="Physical Activity & Facilities" icon={Dumbbell}>
        <div className="flex justify-end mb-3">
          {!editing ? (
            !isReadOnly && <button onClick={startEdit} className="text-xs text-primary hover:underline flex items-center gap-1"><Pencil className="w-3 h-3" /> Edit</button>
          ) : (
      ...
      <Section title="Interests & General Notes" icon={Music}>
        <div className="flex justify-end mb-2">
          {!editing && !isReadOnly && <button onClick={startEdit} className="text-xs text-primary hover:underline flex items-center gap-1"><Pencil className="w-3 h-3" /> Edit</button>}
        </div>
        {editing ? (
