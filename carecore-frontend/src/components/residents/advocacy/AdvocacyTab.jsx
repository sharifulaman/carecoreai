    ...
    <div className="space-y-4">
      ...
      {!record?.informed_of_right && (
        <div className="bg-amber-50 border border-amber-300 rounded-lg p-4">
          ...
          {permCanEdit && <Button onClick={handleInformOfRight} className="bg-amber-600 hover:bg-amber-700">Record: Informed of Right to Advocate</Button>}
        </div>
      )}
      ...
      {record && (
        <div className="bg-card border border-border rounded-lg p-4 space-y-3">
          ...
          {!record.advocate_requested && record.informed_of_right && permCanEdit && (
