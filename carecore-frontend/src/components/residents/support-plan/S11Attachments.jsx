...
export function getAttachmentsStatus(docs) {
  // Reflects real upload state for display. Attachments are optional and must
  // NOT block sign-off — that exclusion is handled separately wherever
  // sectionStatuses is reduced to an "all complete" / "incomplete sections" gate
  // (SupportPlansTab.jsx, S12Signoff.jsx), not by lying about this status.
  if (docs && docs.length > 0) return "completed";
  return "not_started";
}
