...
import AppointmentOutcomeKPIs from "./AppointmentOutcomeKPIs";
...
export default function AppointmentsTab({
  ...
  const { canAdd, canEdit: permCanEdit } = useModuleActions("residents", { canEdit: isAdminOrTL, canAdd: true });
  ...
  return (
    <div className="space-y-4">
      {/* Outcome KPIs */}
      {isAdminOrTL && <AppointmentOutcomeKPIs appointments={filteredAppointments} />}
