      ...
      <header className="h-14 md:h-16 border-b border-border bg-card flex items-center justify-between px-4 md:px-6 shrink-0">
        <div className="flex items-center gap-3 flex-1">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-[10px] md:text-xs text-muted-foreground font-medium mt-0.5 leading-tight">
              {(() => {
                const h = time.getHours();
                if (h >= 7 && h < 15) return "Good Morning";
                if (h >= 15 && h < 23) return "Good Afternoon";
                return "Night Shift";
