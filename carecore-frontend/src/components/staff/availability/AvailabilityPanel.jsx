...
export default function AvailabilityPanel({ staffMember, user, onClose, defaultTab = "profile" }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/40">
      <div className="w-full max-w-[480px] h-full bg-card border-l border-border shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
        ...
        <Tabs defaultValue={defaultTab} className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-5 py-4">
            ...
            <TabsContent value="weekly" className="mt-0">
              <WeeklyPatternTab staffMember={staffMember} user={user} />
            </TabsContent>
