                ...
                return (
                  <tr key={a.id} className="border-b border-slate-50 hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 text-xs">
                      <span className={a.due_date && a.due_date < today && !a.acknowledged_at ? "text-red-600 font-semibold" : "text-slate-500"}>{a.due_date ? format(new Date(a.due_date), "dd MMM yyyy") : "—"}</span>
                    </td>
