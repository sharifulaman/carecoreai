  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const prefixMap = {
        ...
        cleaning: "CLN", maintenance: "MNT", mileage: "MIL", food: "FDS",
        food_supplies: "FDS", food_subsistence: "FDS", accommodation: "ACC",
        equipment: "EQP", training: "TRN", staff_training: "TRN",
        uniform: "UNI", clothing: "UNI", other: "OTH"
      };
      const prefix = prefixMap[form.category?.toLowerCase()] || "OTH";
      const title = `${prefix}-${crypto.randomUUID().split("-")[0].toUpperCase()}`;
      await onSubmit({
        title,
        org_id: ORG_ID,
