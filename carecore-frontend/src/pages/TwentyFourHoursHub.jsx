...
export default function TwentyFourHoursHub() {
  ...
  const { data: residents = [] } = useQuery({
    ...
    queryFn: () => base44.entities.Resident.filter({ status: 'active', service_type: 'twenty_four_hours' }, '-created_date', 100),
  });
  ...
  return (
    <div className="space-y-0" {...outletContext}>
      ...
      <div>
        ...
        {activeTab === 'home-checks' && (
          <div className="mt-4 text-center py-16 text-muted-foreground text-sm">
            Please go to <strong>Homes &rarr; View Home &rarr; Checks, Chores &amp; Audits</strong> tab to manage checks per home.
          </div>
        )}
