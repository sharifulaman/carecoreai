...
import { User, FileText, Calendar, BookOpen, FolderOpen, CalendarDays, MapPin } from "lucide-react";
import MyDetailsSection from "@/components/sw/MyDetailsSection";
import MyTimesheetsSection from "@/components/sw/MyTimesheetsSection";
...
import StaffTrackerTab from "@/components/staff/tracker/StaffTrackerTab";

const TABS = [
  { key: "details", label: "My Details", icon: User },
  { key: "timesheets", label: "My Timesheets", icon: FileText },
  ...
  { key: "tracker", label: "Location Tracker", icon: MapPin },
];
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Manage your personal details, leave, training and documents.
        </p>
      </div>
      ...
      <div className="pb-8">
        ...
        {activeTab === "timesheets" && (
          <MyTimesheetsSection myProfile={myProfile} org={org} />
        )}
        {activeTab === "leave" && (
        ...
        {activeTab === "tracker" && (
          <StaffTrackerTab staffProfile={myProfile} ownLocationOnly={true} />
        )}
      </div>
    </div>
  );
